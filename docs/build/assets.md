...
![AssetObject](../_media/fISNIB0.jpg)
...
<FireBoxRoom>
 <Assets>
  <AssetWebSurface id="janusWebSurface" src="https://janusxr.org" width="1920" height="1080" ></AssetWebSurface>
 </Assets>
 <Room>
...
An AssetScript defines a file containing JavaScript (technically ECMAScript 3 compliant code) that you can run in the FireBoxRoom. Functions can be set up for specific events such as mouse clicks or on frame updates. Sounds can be played, Objects can be created, have their properties modified, and be destroyed. For further details about this, see this page: [Javascript - Room Object](http://janusxr.org/docs/build/roomobject/index.html). Also check the "experiment" workspace included with JanusVR which serves as a JS example.
